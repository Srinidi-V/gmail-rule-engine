...
class RuleEngine:
    ...
    def _evaluate_string_condition(self, email_value: str, predicate: str, condition_value: str) -> bool:
    ...
    def _evaluate_date_condition(self, email_date: Any, predicate: str, value: str, unit: str) -> bool:
